...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "wasmchat.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "wasmchat.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'wasmchat'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'wasmchat':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_0f2ac7dc9557c683f6b3130b78390dfbbcb37d9a": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);let m=($0);myChat.emit("message",{text:m});
            },
            ...
            "__cargo_web_snippet_741fb8f0ae5b267adae6465bb991710f8aaca479": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){let ce=ChatEngineCore.create({publishKey:($1),subscribeKey:($2)});console.log("Chat engine core created");return ce;})());
            },
            ...
            "__cargo_web_snippet_b150bd5a0633ad128c96088d3a9bdee33fc1d24b": function($0, $1, $2, $3, $4, $5, $6) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);$4 = Module.STDWEB_PRIVATE.to_js($4);$5 = Module.STDWEB_PRIVATE.to_js($5);$6 = Module.STDWEB_PRIVATE.to_js($6);Module.STDWEB_PRIVATE.from_js($0, (function(){var pn=($1);var chat_callback=($2);var online_cb=($3);var offline_cb=($4);pn.on("$.ready",function(data){console.log("PubNub Chat Engine Ready");me=data.me;myChat=new pn.Chat(($5));myChat.on("$.connected",()=>{console.log("The chat is connected!");myChat.on("message",(message)=>{chat_callback(message.data.text,message.sender.state.nickName);console.log("message: "+message.data.text+" from "+message.sender.state.nickName);});myChat.on("$.online.*",(data)=>{console.log("User is Online: ",data.user);online_cb(data.user.state.nickName);});myChat.on("$.offline.*",(data)=>{console.log("User is Offline: ",data.user);offline_cb(data.user.state.nickName);});});});pn.connect(String(new Date().getTime()),{nickName:($6)});console.log("pubnub connecting");return myChat;})());
            },
